    ...
    try:
        ...
        if usage[today][user_id] >= 30:
            requests.post(
                ...
                json={"chat_id": chat_id, "text": "ขออภัย คุณได้ครบ 30 ครั้งแล้วในวันนี้"}
            )
            return
        ...
        system_prompt = (
            ...
            "จงหลากหลาย ให้คำแนะนำกระชับ ตรงประเด็น และชวนให้กำลังใจพนักงาน -\n"
            "หากคำถามไม่ชัดเจนให้ถามกลับอย่างนอบน้อม"
        )
