    ...
    try:
        ...
        if usage[today][user_id] >= 30:
            requests.post(
                ...
                json={"chat_id": chat_id, "text": "ขอโทษ คุณใช้ครบ 30 ครั้งแล้วในวันนี้"}
            )
            return
        ...
        system_prompt = (
            ...
            "จุดมุ่งหมาย ให้ค้นเจาะลึกกระชับ ตรงประเด็น และช่วยให้คำสั่งใจพนักงาน "
            "หากคำถามไม่เหมาะให้ตอบกลับอย่างอ่อนโยน"
        )
